...
public class MiscUtil {
    ...
    public static void mine(BlockPos blockPos) {
        ...
        Objects.requireNonNull(mc.getNetworkHandler()).sendPacket(new PlayerActionC2SPacket(PlayerActionC2SPacket.Action.START_DESTROY_BLOCK, blockPos, Direction.UP));
